  ...
  return (
    <div className="group relative w-full max-w-[700px] [perspective:1200px]">
      <div className="relative aspect-[1088/704] transition-transform duration-700 group-hover:[transform:rotateX(3deg)_rotateY(-3deg)]">
        ...
        <div className="absolute left-[18.5%] top-[24.7%] z-10 h-[57.7%] w-[59.7%] overflow-hidden rounded-[1.2%] bg-white">
        ...
        <div className="pointer-events-none absolute left-[18.5%] top-[24.7%] z-20 h-[57.7%] w-[59.7%] rounded-[1.2%] shadow-[inset_0_0_18px_rgba(0,0,0,0.24)]" />
      </div>
