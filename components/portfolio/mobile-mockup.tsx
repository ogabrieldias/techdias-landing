  ...
  return (
    <div className="group absolute -bottom-5 right-0 z-20 aspect-square w-[150px] [perspective:900px] sm:-bottom-8 sm:right-3 sm:w-[210px] lg:right-[-26px]">
      ...
      <div className="absolute left-[32.8%] top-[11.1%] h-[81.4%] w-[29.1%] overflow-hidden rounded-[13%] bg-white">
        <img src={src} alt={alt} className="block w-full origin-top object-cover object-top transition-transform duration-[2400ms] ease-in-out group-hover:-translate-y-[28%]" />
      </div>
    </div>
  )
}
